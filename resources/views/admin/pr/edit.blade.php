...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form class="row g-3" action="{{ url('/admin/pr/update/'.$pr->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">ชื่อกิจกรรม</label>
                        <input type="text" class="form-control" id="name" name="name" value="{{ $pr->name }}">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="date" name="date" value="{{ $pr->date }}">
                        @error('date')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="row mb-3">
                        <div class="col-12">
                            <img id="showImage2" class="rounded avatar-lg" src="{{ url('back_end/image/pr/resize/'.$pr->file) }}" width="250"
                                alt="Card image cap" >
                        </div>
                    </div>
                </div>
