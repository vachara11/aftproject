    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">เพิ่มรายการปริ้นเอกสาร</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

            <form class="row g-3" action="{{route('printinsert')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select" name="year" style="width: 100%;">
                            <option selected="selected">กรุณาเลือกภาคเรียน/ปีการศึกษา</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select" name="type" style="width: 100%;">
                            <option selected="selected">กรุณาเลือกประเภทเอกสาร</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select" name="fname" style="width: 100%;">
                            <option selected="selected">กรุณาเลือกชื่อผู้สั่งปริ้น</option>
