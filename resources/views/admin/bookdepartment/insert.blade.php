    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">เพิ่มเล่มแสกนโครงการชมรมวิชาชีพ</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

            <form class="row g-3" action="{{url('admin/bookdepartment/create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row mb-3">
                        <div class="col-12">
                            <img id="showImage2" class="rounded avatar-lg" src="{{ url('back_end/image/bookdepartment/noimg.jpg') }}" width="250"
                                alt="Card image cap" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="comnent">หมายเหตุ</label>
                        <input type="text" class="form-control" id="comnent" name="comnent">
                        @error('comnent')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
        ...
        <a href="{{url('/admin/bookdepartment/index')}}"><button type="button" class="btn btn-success"> ย้อนกลับหน้าหลัก</button> </a>
