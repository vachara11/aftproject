...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form class="row g-3" action="{{url('admin/bookdepartment/update/'.$pro->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row mb-3">
                        <div class="col-12">
                            <img id="showImage2" class="rounded avatar-lg" src="{{ url('back_end/image/bookdepartment/'.$pro->image) }}" width="250"
                                alt="Card image cap" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="comnent" name="comnent" value="{{$pro->comnent}}">
                        @error('comnent')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
