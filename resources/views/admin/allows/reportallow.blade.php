...
<head>
    ...
    <title>หนังสือขออนุญาตจัดทำโครงการ</title>
    ...
    <htmlpageheader name="page-header">
        <div class="container">
            <table class="table table-bordered border-primary">
                <tr class="border-bottom">
                    ...
                    <td class="border-start"> <br>
                        ...
                        <p>&nbsp;&nbsp;<b>วันที่</b>&nbsp;{{ $allow->datewr }} <br></p>
                        <p>&nbsp;&nbsp;<b>เลขที่</b> {{ $allow->number }}</p>
                    </td>
                </tr>
            </table>
            <div class="mx-3">
            ...
            <div class="mx-5">
                ...
                <b>เรื่อง</b>
                ขออนุญาตจัดทำ{{ $allow->name }} <br>

               <div class="my_space">
                <b>สิ่งที่แนบมาด้วย</b> ๑.
                บันทึกการขออนุมัติโครงการ<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 ๒. แบบเสนอโครงการ <br>
               </div>
                <p style="text-align:justify;" class="my_space mt-2">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ตามที่องค์การนักวิชาชีพในอนาคตแห่งประเทศไทยวิทยาลัยเทคโนโลยีพงษ์สวัสดิ์ได้ขออนุมัติจัดทำ {{ $allow->name." ".$allow->date." ".$allow->location." ".$allow->activity}} นั้น <br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;องค์การนักวิชาชีพในอนาคตแห่งประเทศไทยวิทยาลัยเทคโนโลยีพงษ์สวัสดิ์จึงขออนุญาตจัดทำ{{ $allow->name }}โครงการดังแนบมานี้ <br>
                <div class="my_space mt-2">
...
<div class="text-center my_space mt-2">
    ลงชื่อ.................................................... <br>
