...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form class="row g-3" action="{{url('admin/createMicenumber')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">

                    <div class="form-group">
                        <label for="number">เลขทะเบียนส่ง</label>
                        <input type="text" class="form-control" id="number" name="number" value="มอว.">
                        @error('number')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="go" name="go" value="ชมรมวิชาชีพไมซ์และอีเว้นต์">
                        @error('go')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
        ...
        <a href="{{url('admin/Micenumber/')}}"><button type="button" class="btn btn-success"> ย้อนกลับหน้าหลัก</button> </a>
