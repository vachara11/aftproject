    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h3 class="card-title">แก้ไขข้อมูลการสมัครสมาชิกชมรมวิชาชีพและอวท.วิทยาลัยเทคโนโลยีพงษ์สวัสดิ์</h3>
            </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="row g-3" action="{{url('membership/font_end/update/'.$membership->id)}}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label>วันที่สมัคร</label>
                            <select class="form-control select" name="days" style="width: 100%;">
                                <option selected="selected">{{$membership->days}}</option>
                                <option>๐๑</option>
                                <option>๐๒</option>
                                <option>๐๓</option>
                                <option>๐๔</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="months" style="width: 100%;">
                                <option selected="selected">{{$membership->months}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="years" style="width: 100%;">
                                <option selected="selected">{{$membership->years}}</option>
                                <option>๒๕๖๒</option>
                                <option>๒๕๖๓</option>
                                <option>๒๕๖๔</option>
                                <option>๒๕๖๕</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="classroom" style="width: 100%;">
                                <option selected="selected">{{$membership->classroom}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="student_id" name="student_id" value="{{$membership->student_id}}">
                            @error('student_id')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="department" style="width: 100%;">
                                <option selected="selected">{{$membership->department}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="major_works" style="width: 100%;">
                                <option selected="selected">{{$membership->major_works}}</option>
                                <option>การบัญชี</option>
                                <option>การตลาด</option>
                                <option>เทคโนโลยีสารสนเทศ</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="day" style="width: 100%;">
                                <option selected="selected">{{$membership->day}}</option>
                                <option>๐๑</option>
                                <option>๐๒</option>
                                <option>๐๓</option>
                                <option>๐๔</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="month" style="width: 100%;">
                                <option selected="selected">{{$membership->month}}</option>
                                <option>มกราคม</option>
                                <option>กุมภาพันธ์</option>
                                <option>มีนาคม</option>
                                <option>เมษายน</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="year" style="width: 100%;">
                                <option selected="selected">{{$membership->year}}</option>
                                <option>๒๕๐๐</option>
                                <option>๒๕๐๑</option>
                                <option>๒๕๐๒</option>
                                <option>๒๕๐๓</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="house_number" name="house_number" value="{{$membership->house_number}}">
                            @error('house_number')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="alley" name="alley" value="{{$membership->alley}}">
                            @error('alley')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="road" name="road" value="{{$membership->road}}">
                            @error('road')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="district" name="district" value="{{$membership->district}}">
                            @error('district')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="county" name="county" value="{{$membership->county}}">
                            @error('county')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="province" name="province" value="{{$membership->province}}">
                            @error('province')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="zip_code" name="zip_code" value="{{$membership->zip_code}}">
                            @error('zip_code')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="phone" name="phone" class="form-control" value="{{$membership->phone}}">
                            </div>
                            <!-- /.input group -->
                            @error('phone')
                            <span class="text-danger">{{$message}}</span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="father" name="father" value="{{$membership->father}}">
                            @error('father')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mother" name="mother" value="{{$membership->mother}}">
                            @error('mother')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="professional" style="width: 100%;">
                                <option selected="selected">{{$membership->professional}}</option>
                                <option>การบัญชี</option>
                                <option>การตลาด</option>
                                <option>เทคโนโลยีสารสนเทศ</option>
                                <option>คอมพิวเตอร์กราฟิก</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="parent" name="parent" value="{{$membership->parent}}">
                            @error('parent')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="row mt-4">
                            <div class="col">
                                <button type="submit" class="btn btn-info"><i class="fas fa-save"></i> อัพเดท</button>
                                <a href="{{route('datasearch.fontend')}}"><button type="button" class="btn btn-danger"><i class="far fa-hand-point-left"></i> กลับ</button></a>
                            </div>
                        </div>
                    </div>
