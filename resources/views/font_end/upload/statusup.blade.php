        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h6 class="card-title"> <strong>ตรวจสอบสถานะเอกสารคำร้องขอซ่อมกิจกรรม</strong> </h6>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="alert alert-primary" role="alert">{{$status->status}}</div> 
                                    @elseif ($status->status =="ไม่ผ่าน")
                                    <div class="alert alert-danger" role="alert">{{$status->status}}</div>
                                    @elseif ($status->status =="ส่งคะแนนแล้ว")
                                    <div class="text-success">{{$status->status}}</div>
                                    @else
                                    <div class="alert alert-info" role="alert">{{$status->status}}</div>
                                    @endif
                                </td>
                                <td class="text-danger">{{$status->comment}}</td>
                                <td class="text-center">
                                 @if ($status->edit == 0)
                                            <a href="{{ url('status/upload/editup/' . $status->id) }}">
