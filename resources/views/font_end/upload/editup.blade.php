    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="row g-3" action="{{url('status/upload/uploadup/'.$statusup->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">

                        <div class="form-group">
                            <label for="std_id">รหัสนักเรียน นักศึกษา</label>
                            <input type="text" class="form-control" id="std_id" name="std_id" value="{{$statusup->std_id}}">
                            @error('std_id')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{$statusup->name}}">
                            @error('name')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="{{$statusup->phone}}">
                            @error('phone')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="department" style="width: 100%;">
                                <option value="{{$statusup->department}}" selected>{{$statusup->department}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="class" style="width: 100%;">
                                <option value="{{$statusup->class}}" selected>{{$statusup->class}}</option>
                                <option>ปวช.๑</option>
                                <option>ปวช.๒</option>
                                <option>ปวช.๓</option>
                                <option>ปวส.๑</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" name="room" style="width: 100%;">
                                <option value={{$statusup->room}} selected>{{$statusup->room}}</option>
                                <option>๑</option>
                                <option>๒</option>
                                <option>๓</option>
                                <option>๔</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <!-- <a href="{{asset('font_end/upload/'.$statusup->file)}}" class="test-success">ดูไฟล์ที่นี้</a> -->
                            </div>
                        </div>
            ...
            <a href="{{route('statusup')}}"><button type="button" class="btn btn-success"> ย้อนกลับหน้าหลัก</button> </a>
