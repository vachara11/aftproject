        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">แก้ไขการส่งเอกสารรายงาน</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="row g-3" action="{{url('status/upload/uploadre/'.$statusre->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <!-- <a href="{{asset('font_end/upload/'.$statusre->file)}}" class="test-success">ดูไฟล์ที่นี้</a> -->
                            </div>
                        </div>
            ...
            <a href="{{route('statusre')}}"><button type="button" class="btn btn-success"> ย้อนกลับหน้าหลัก</button> </a>
